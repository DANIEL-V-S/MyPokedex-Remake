...
public class FragmentEditPokemonStats extends Fragment {
    ...
    private void setValues() {
        getEdtHp().setText(String.valueOf(getViewModelPokemon().getPokemonClass().getBase_hp()));
        getEdtAtk().setText(String.valueOf(getViewModelPokemon().getPokemonClass().getBase_atk()));
        getEdtDef().setText(String.valueOf(getViewModelPokemon().getPokemonClass().getBase_def()));
        getEdtSpAtk().setText(String.valueOf(getViewModelPokemon().getPokemonClass().getBase_spatk()));
        getEdtSpDef().setText(String.valueOf(getViewModelPokemon().getPokemonClass().getBase_spdef()));
        getEdtSpeed().setText(String.valueOf(getViewModelPokemon().getPokemonClass().getBase_speed()));
    }
